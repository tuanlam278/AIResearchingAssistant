                ...
                {isAssistant && !msg.streaming && (
                  <div className="rw-bubble-actions">
                    ...
                    <button
                      ...
                      onClick={() => onShowSources(citations[0])}
                    >
                      Nguồn
                    </button>
                    <button
...
function SourcesPanel({ citations, invalidCount, diagnostics }) {
  ...
  return (
    <div className="rw-right-content rw-scroll">
      ...
      <Modal title="Chi tiết nguồn" onClose={() => setDetail(null)}>
        {detail && (
          <>
            <div className="rw-card-title">
            ...
            <p style={{ whiteSpace: "pre-wrap" }}>
              {detail.snippet || "Backend chưa trả snippet chi tiết hơn."}
            </p>
            <button
              className="rw-soft-btn"
              type="button"
...
export default function ResearchWorkspace() {
  ...
  const showSources = (citation) => {
    if (citation && !currentCitations.length) setCurrentCitations([citation]);
    setRightTab("sources");

-- Durable indexing jobs for background document parsing/chunking/embedding.
...
create trigger trg_indexing_jobs_updated_at
before update on public.indexing_jobs
for each row execute function public.touch_indexing_jobs_updated_at();
